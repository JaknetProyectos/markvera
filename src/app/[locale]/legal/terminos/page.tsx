  ...
  return (
    <div className="legal-container">
      ...
      <section>
        ...
        <p>
          Es un gusto tenerle por mark-vera.com (en adelante “Sitio Web”), operado
          por DISTRIBUCIONES EL KILO S.A. DE C.V. (en adelante, “MARKVERA”),
        ...
        <p>
          MARKVERA no asume responsabilidad por actos realizados por menores de edad
          ...
          parte de menores de edad sin la debida supervisión, MARKVERA se reserva el
        ...
        <p>
          MARKVERA es una empresa especializada en el desarrollo de software
        ...
        <p>
          ...
          comercial. MARKVERA se reserva el derecho de actualizar, suspender o
        ...
        <p>
          ...
          escrita previa de MARKVERA. Esta prohibición se extiende a cualquier forma
        ...
        <p>
          ...
          seguridad o estabilidad de los sistemas de MARKVERA.
        </p>
        ...
        <p>
          ...
          notifique inmediatamente a MARKVERA sobre accesos no autorizados,
          proporcionando toda la información disponible sobre el incidente.
        </p>

        <p>
          MARKVERA se reserva el derecho de rechazar cualquier solicitud de registro
          ...
          MARKVERA notificará al Usuario las razones específicas y, cuando sea
        ...
        <p>
          MARKVERA cumple estrictamente con la Ley Federal de Protección de Datos
        ...
        <p>
          ...
          autorizado, uso indebido, alteración o destrucción. MARKVERA no compartirá
        ...
        <p>
          ...
          técnica y comercial. MARKVERA se esfuerza por mantener la información
        ...
        <p>
          MARKVERA proporcionará estimaciones de tiempo y presupuesto basadas en la
        ...
        <p>
          ...
          través del Sitio Web, correo electrónico o contacto telefónico. MARKVERA
        ...
        <p>
          ...
          naturales para aceptar la propuesta, después del cual MARKVERA podrá
        ...
        <p>
          MARKVERA acepta diversas formas de pago que pueden incluir transferencia
        ...
        <p>
          En caso de fallas en el procesamiento de pagos, MARKVERA notificará
          ...
          MARKVERA no almacena datos bancarios, los cuales son procesados por terceros
          bajo estrictos estándares de seguridad PCI DSS.
        </p>

        <p>
          Una vez confirmado cada pago, MARKVERA enviará vía correo electrónico la
        ...
        <p>
          ...
          Generalmente, MARKVERA retiene los derechos sobre metodologías, frameworks,
        ...
        <p>
          ...
          elementos gráficos, son propiedad exclusiva de MARKVERA o de sus
        ...
        <p>
          ...
          intelectual de MARKVERA por el mero uso del Sitio Web o la contratación de
          servicios.
        </p>
        ...
        <p>
          MARKVERA se compromete a mantener absoluta confidencialidad sobre toda la
        ...
        <p>
          ...
          MARKVERA emplee en la prestación de servicios. Esta información se considera
        ...
        <p>
          ...
          responsabilidad. MARKVERA no garantiza la continuidad ininterrumpida del
        ...
        <p>
          MARKVERA hará sus mejores esfuerzos para proporcionar servicios de calidad,
          ...
          La responsabilidad de MARKVERA se limita a la prestación de los servicios
          conforme a las especificaciones técnicas acordadas.
        </p>

        <p>
          En ningún caso MARKVERA será responsable por daños indirectos,
        ...
        <p>
          La responsabilidad total de MARKVERA, por cualquier causa y bajo cualquier
        ...
        <p>
          MARKVERA podrá terminar inmediatamente la prestación de servicios, sin
        ...
        <p>
          MARKVERA podrá modificar estos Términos y Condiciones en cualquier momento,
  ...
  return (
    <div className="legal-container">
      ...
      <section>
        ...
        <p>
          We are pleased to welcome you to mark-vera.com (hereinafter, the
          “Website”), operated by DISTRIBUCIONES EL KILO S.A. DE C.V.
          (hereinafter, “MARKVERA”), a company legally incorporated under Mexican
        ...
        <p>
          ...
          constitutes a binding agreement between the User and MARKVERA.
        </p>
        ...
        <p>
          MARKVERA assumes no responsibility for acts carried out by minors or
          ...
          guardians or legal representatives. If MARKVERA detects the use of the
        ...
        <p>
          MARKVERA is a company specialized in custom software development,
        ...
        <p>
          ...
          services, as specified in each commercial proposal. MARKVERA reserves the
        ...
        <p>
          ...
          material, without prior written authorization from MARKVERA. This
        ...
        <p>
          ...
          stability of MARKVERA’s systems.
        </p>
        ...
        <p>
          ...
          MARKVERA of unauthorized access and provide all available information about
          the incident.
        </p>

        <p>
          MARKVERA reserves the right to reject any registration request or suspend
          ...
          Conditions. In the event of suspension, MARKVERA shall notify the User of
        ...
        <p>
          MARKVERA strictly complies with the Federal Law on Protection of Personal
        ...
        <p>
          ...
          misuse, alteration, or destruction. MARKVERA shall not share personal
        ...
        <p>
          ...
          commercial availability. MARKVERA strives to keep information updated and
        ...
        <p>
          MARKVERA shall provide time and budget estimates based on the information
        ...
        <p>
          ...
          email, or telephone contact. MARKVERA shall prepare a detailed commercial
        ...
        <p>
          ...
          the proposal, after which MARKVERA may modify the offered conditions.
        </p>
        ...
        <p>
          MARKVERA accepts various payment methods, which may include bank transfer,
        ...
        <p>
          In the event of payment processing failures, MARKVERA shall immediately
          ...
          contact the card issuer directly. MARKVERA does not store banking data,
          which is processed by third parties under strict PCI DSS security
          standards.
        </p>

        <p>
          Once each payment is confirmed, MARKVERA shall send the corresponding
        ...
        <p>
          ...
          MARKVERA retains rights over methodologies, frameworks, tools, and reusable
        ...
        <p>
          ...
          exclusive property of MARKVERA or its licensors and are protected by
        ...
        <p>
          ...
          actions. The User acquires no rights whatsoever over MARKVERA’s
        ...
        <p>
          MARKVERA undertakes to maintain absolute confidentiality regarding all
        ...
        <p>
          ...
          MARKVERA in the provision of services. Such information is considered a
        ...
        <p>
          ...
          MARKVERA does not guarantee uninterrupted continuity of the Website or the
        ...
        <p>
          MARKVERA shall use its best efforts to provide quality services, but does
          not guarantee specific business results, increases in sales, productivity
          improvements, or any other particular commercial benefit. MARKVERA’s
          liability is limited to the provision of services in accordance with the
          agreed technical specifications.
        </p>

        <p>
          Under no circumstances shall MARKVERA be liable for indirect, incidental,
        ...
        <p>
          MARKVERA’s total liability, for any cause and under any legal theory, shall
        ...
        <p>
          MARKVERA may immediately terminate the provision of services, without any
        ...
        <p>
          ...
          on project progress and resources already committed by MARKVERA.
        </p>
        ...
        <p>
          MARKVERA may modify these Terms and Conditions at any time by publishing
